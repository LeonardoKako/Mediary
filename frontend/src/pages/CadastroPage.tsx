...
import { ChevronLeft, User, Mail, Lock, Eye, EyeOff, UserPlus } from "lucide-react";
    ...
    <div className="flex flex-col h-full min-h-screen bg-brand-blue overflow-hidden">
      ...
      <div className="flex-[0.25] flex flex-col justify-center items-center py-4 px-6 relative">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="bg-brand-navy p-4 rounded-3xl shadow-2xl transform rotate-[3deg] flex items-center justify-center border-4 border-white/10 scale-90">
      ...
      <div className="flex-[0.75] bg-gray-50 rounded-t-[40px] shadow-2xl px-8 pt-10 pb-6 flex flex-col animate-slide-up relative z-20">
        <div className="text-center mb-8">
            <h1 className="text-3xl font-black text-brand-navy tracking-[0.1em] uppercase">
                Cadastro
            </h1>
        ...
        <form onSubmit={handleRegister} className="w-full space-y-5 max-w-sm mx-auto">
